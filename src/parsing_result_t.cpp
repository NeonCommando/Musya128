...
void print(parsing_result_t pr) {
    ...
    std::cout << "28-37 sp_begin_: " << uint128tostr(pr.header_.sp_begin_) << "\n";
    std::cout << "38-47 const_begin_addr_: " << uint128tostr(pr.header_.const_begin_addr_) << "\n";
    std::cout << "48-57 const_size_: " << uint128tostr(pr.header_.const_size_) << "\n";
    std::cout << "58-67 var_begin_addr_: " << uint128tostr(pr.header_.var_begin_addr_) << "\n";
    std::cout << "68-77 var_size_: " << uint128tostr(pr.header_.var_size_) << "\n";
    std::cout << "78-87 code_begin_addr_: " << uint128tostr(pr.header_.code_begin_addr_) << "\n";
    std::cout << "88-97 code_size_: " << uint128tostr(pr.header_.code_size_) << "\n";
    printf("content:\n");
